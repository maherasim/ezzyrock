...
export const SEARCH_API = (queryPerams) => { return `${BASE_URL}/search-list?${generateQueryParams(queryPerams)}` }
export const ZONES_API = (queryPerams) => { return `${BASE_URL}/zones?${generateQueryParams(queryPerams)}` }
export const REMOVE_SESSION = `${BASE_URL}/remove-session`
export const SET_SESSION = `${BASE_URL}/set-location`
...
export const PROMOTIONAL_BANNER_API = (queryPerams) => { return `${BASE_URL}/promotionalbanner-list?${generateQueryParams(queryPerams)}` }