        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.product_orders') .
                    '</span></span>',
                ['route' => 'admin.product-orders.index'],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4 7H20M4 12H20M4 17H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M16 17L18 19L22 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>',
            )
        ...
        //         )
        //         ->prepend(
        //             '<svg width="15" height="15" class="sidebar-menu-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        //                 <path d="M93.9 145.9C104.4 116 132.6 96 164.3 96L476.5 96C508.2 96 536.4 116 546.9 145.9L565.3 198.5C576.3 230 566.3 262.4 544.4 282.9L544.4 472.1C544.4 511.9 512.2 544.1 472.4 544.1L168.4 544.1C128.6 544.1 96.4 511.9 96.4 472.1L96.4 282.9C74.5 262.4 64.5 230 75.5 198.5L93.9 145.9zM144.4 303.8L144.4 384L496.4 384L496.4 303.8C494.4 303.9 492.5 304 490.5 304C468.7 304 448.7 295.1 434.3 280.7C419.7 295.1 399.7 304 377.4 304C355.2 304 335 295 320.4 280.5C305.8 295 285.6 304 263.4 304C241.1 304 221.1 295.1 206.5 280.7C192.1 295.2 172.2 304 150.3 304C148.3 304 146.3 303.9 144.3 303.8zM238.1 144L230.5 219.7C228.6 239.1 243.8 256 263.3 256C281.5 256 296.3 241.2 296.3 223L296.3 144L238 144zM344.4 223C344.4 241.2 359.2 256 377.4 256C396.9 256 412.2 239.1 410.2 219.7L402.6 144L344.3 144L344.3 223zM459.3 227.8C460.9 243.8 474.4 256 490.4 256C512 256 527.1 234.7 519.9 214.4L501.6 161.8C497.9 151.1 487.8 144 476.5 144L450.9 144L459.3 227.8zM150.4 256C166.5 256 179.9 243.8 181.5 227.8L189.9 144L164.3 144C153 144 143 151.1 139.2 161.8L120.8 214.4C113.7 234.8 128.8 256 150.3 256zM144.4 472C144.4 485.3 155.1 496 168.4 496L472.4 496C485.7 496 496.4 485.3 496.4 472L496.4 432L144.4 432L144.4 472z"/>
        //             </svg>',
        //         )
        //         ->data('permission', [
        //             'shop list',
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.category') .
                    '</span></span>',
                ['route' => ['category.index', 'module' => 'service']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.subcategory') .
                    '</span></span>',
                ['route' => ['subcategory.index', 'module' => 'service']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M9 1.6875C7.55373 1.6875 6.13993 2.11637 4.9374 2.91988C3.73486 3.72339 2.7976 4.86544 2.24413 6.20163C1.69067 7.53781 1.54586 9.00811 1.82801 10.4266C2.11017 11.8451 2.80661 13.148 3.82928 14.1707C4.85196 15.1934 6.15492 15.8898 7.57341 16.172C8.99189 16.4541 10.4622 16.3093 11.7984 15.7559C13.1346 15.2024 14.2766 14.2651 15.0801 13.0626C15.8836 11.8601 16.3125 10.4463 16.3125 9C16.3105 7.06123 15.5394 5.20246 14.1685 3.83154C12.7975 2.46063 10.9388 1.68955 9 1.6875ZM15.1875 9C15.1881 9.79381 15.0353 10.5803 14.7375 11.3161L11.5945 9.3832C11.4609 9.30074 11.3114 9.24732 11.1558 9.22641L9.55125 9.00984C9.33016 8.98101 9.10547 9.01808 8.90535 9.11639C8.70522 9.2147 8.53856 9.36988 8.42625 9.5625H7.81313L7.54594 9.00984C7.47207 8.85596 7.36397 8.72102 7.22991 8.61535C7.09585 8.50969 6.93939 8.4361 6.7725 8.40023L6.21 8.27859L6.75985 7.3125H7.93477C8.12489 7.31213 8.31184 7.26376 8.47828 7.17188L9.33961 6.69656C9.41529 6.65438 9.48603 6.60391 9.55055 6.54609L11.4427 4.83469C11.6324 4.66468 11.7584 4.43509 11.8001 4.18378C11.8418 3.93248 11.7966 3.67448 11.6719 3.45234L11.6466 3.40664C12.7053 3.90867 13.6 4.70067 14.2268 5.69071C14.8535 6.68075 15.1867 7.82824 15.1875 9ZM10.0765 2.90672L10.6875 4.00078L8.79539 5.71219L7.93477 6.1875H6.75985C6.56209 6.18721 6.36774 6.23905 6.19641 6.33781C6.02507 6.43656 5.88279 6.57873 5.78391 6.75L5.17008 7.82086L4.45641 5.91961L5.22563 4.10063C5.90649 3.57454 6.68974 3.19647 7.52518 2.99064C8.36063 2.7848 9.22986 2.75574 10.0772 2.90531L10.0765 2.90672ZM2.8125 9C2.81156 8.08033 3.01675 7.17213 3.41297 6.34219L4.21032 8.47055C4.27676 8.64677 4.38639 8.80349 4.52914 8.92633C4.67189 9.04918 4.84319 9.13423 5.02735 9.17367L6.53414 9.49781L6.80203 10.0547C6.895 10.2441 7.03909 10.4037 7.21801 10.5155C7.39692 10.6274 7.60355 10.6869 7.81453 10.6875H7.9186L7.41024 11.8287C7.32067 12.0296 7.29198 12.2524 7.32772 12.4695C7.36346 12.6866 7.46207 12.8884 7.61133 13.05L7.62117 13.0598L9 14.4802L8.8636 15.1833C7.24769 15.1457 5.71047 14.478 4.57996 13.3228C3.44945 12.1676 2.81518 10.6163 2.8125 9ZM10.0252 15.1017L10.1046 14.6932C10.1373 14.5196 10.1288 14.3409 10.08 14.1711C10.0312 14.0014 9.94327 13.8455 9.82336 13.7159C9.81991 13.7128 9.81662 13.7095 9.81352 13.706L8.4375 12.2864L9.40078 10.125L11.0053 10.3416L14.22 12.3187C13.7543 13.0502 13.1403 13.6758 12.4177 14.1551C11.6952 14.6345 10.8801 14.957 10.0252 15.1017Z" fill="#5F60B9"/>
  ...
  <path d="M22 13L21 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        // ========== ECOMMERCE (Category, Sub Category, Products — zones: use Service section menu) ==========
        $menu
            ->add(__('messages.sidebar_form_title', ['form' => trans('messages.ecommerce')]), [
                'class' => 'category-main',
            ])
            ->data('permission', ['category list', 'subcategory list', 'product list']);
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.category') .
                    '</span></span>',
                ['route' => ['category.index', 'module' => 'ecommerce']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.70588 12.9268H9.11765C10.1979 12.9268 11.0735 13.8024 11.0735 14.8826V20.2944C11.0735 21.3746 10.1979 22.2503 9.11765 22.2503H3.70588C2.62568 22.2503 1.75 21.3746 1.75 20.2944V14.8826C1.75 13.8024 2.62568 12.9268 3.70588 12.9268Z" stroke="currentColor" stroke-width="1.5"/>
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.subcategory') .
                    '</span></span>',
                ['route' => ['subcategory.index', 'module' => 'ecommerce']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M18.9645 3.96447L17.4853 2.48528C17.2959 2.29589 17.2012 2.20119 17.0891 2.13591C17.0114 2.09062 16.9279 2.05604 16.8409 2.03308C16.7155 2 16.5816 2 16.3137 2C15.0861 2 14.4724 2 14.0134 2.26029C13.6989 2.43864 13.4386 2.6989 13.2603 3.01338C13 3.47235 13 4.08614 13 5.31371V6.5C13 7.90446 13 8.60669 13.3371 9.11114C13.483 9.32952 13.6705 9.51702 13.8889 9.66294C14.3933 10 15.0955 10 16.5 10C17.9045 10 18.6067 10 19.1111 9.66294C19.3295 9.51702 19.517 9.32952 19.6629 9.11114C20 8.60669 20 7.89611 20 6.47495C20 5.8414 20 5.52462 19.9098 5.23452C19.8736 5.11833 19.827 5.00567 19.7704 4.89796C19.629 4.62904 19.4075 4.40751 18.9645 3.96447Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M13.5 6.5C13.5 4.29086 15.2909 2.5 17.5 2.5C19.7091 2.5 21.5 4.29086 21.5 6.5C21.5 8.70914 19.7091 10.5 17.5 10.5H14.6429C14.5102 10.5 14.4438 10.5 14.388 10.4937C13.9244 10.4415 13.5585 10.0756 13.5063 9.61196C13.5 9.55616 13.5 9.48982 13.5 9.35714V6.5Z" stroke="currentColor" stroke-width="1.5"/>
            ...
            ->nickname('ecommerce_products')
            ->data('permission', 'product list')
            ->link->attr(['class' => ''])
            ->href('#ecommerce_products');

        $menu->ecommerce_products
            ->add('<span>' . trans('messages.all_form_title', ['form' => trans('messages.products')]) . '</span>', [
                'class' => 'sidebar-layout',
                'route' => 'product.index',
            ])
            ->prepend(
...
<path d="M13 16L18 16" stroke="#currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        $menu->ecommerce_products
            ->add('<span>' . trans('messages.add_form_title', ['form' => trans('messages.product')]) . '</span>', [
                'class' => 'sidebar-layout',
...
<path d="M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
            ...
            ->data('permission', 'product add')
            ->link->attr(['class' => '']);

        $menu->ecommerce_products
            ->add('<span>Product Attributes</span>', [
                'class' => 'sidebar-layout',
...
<circle cx="17.5" cy="18" r="2.5" stroke="currentColor" stroke-width="1.5"/>
</svg>',
            )
            ->data('permission', 'product list')
            ->link->attr(['class' => '']);
        ...
        $menu->ecommerce_products
            ->add('<span>' . trans('messages.product_units_menu') . '</span>', [
                'class' => 'sidebar-layout',
                'route' => 'product-units.index',
            ])
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4 19H20M6 5V19M10 5V19M14 5V19M18 5V19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M4 5H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        $menu->ecommerce_products
            ->add('<span>Product Reviews</span>', [
                'class' => 'sidebar-layout',
                'route' => 'product-review.index',
            ])
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 3.75L14.3959 8.6041L19.7541 9.38278L15.877 13.1609L16.792 18.4972L12 15.9779L7.20797 18.4972L8.12302 13.1609L4.24593 9.38278L9.6041 8.6041L12 3.75Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
</svg>',
            )
            ->data('permission', 'product list')
            ->link->attr(['class' => '']);

        // Ecommerce module-specific plan menu removed.

        // ========== CLASSIFIEDS (Category, Sub Category, Classifieds — zones: use Service section menu) ==========
        $menu
            ->add(__('messages.sidebar_form_title', ['form' => trans('messages.classifieds')]), [
                'class' => 'category-main',
            ])
            ->data('permission', ['category list', 'subcategory list', 'post list']);
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.category') .
                    '</span></span>',
                ['route' => ['category.index', 'module' => 'classified']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.70588 12.9268H9.11765C10.1979 12.9268 11.0735 13.8024 11.0735 14.8826V20.2944C11.0735 21.3746 10.1979 22.2503 9.11765 22.2503H3.70588C2.62568 22.2503 1.75 21.3746 1.75 20.2944V14.8826C1.75 13.8024 2.62568 12.9268 3.70588 12.9268Z" stroke="currentColor" stroke-width="1.5"/>
        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    __('messages.subcategory') .
                    '</span></span>',
                ['route' => ['subcategory.index', 'module' => 'classified']],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M18.9645 3.96447L17.4853 2.48528C17.2959 2.29589 17.2012 2.20119 17.0891 2.13591C17.0114 2.09062 16.9279 2.05604 16.8409 2.03308C16.7155 2 16.5816 2 16.3137 2C15.0861 2 14.4724 2 14.0134 2.26029C13.6989 2.43864 13.4386 2.6989 13.2603 3.01338C13 3.47235 13 4.08614 13 5.31371V6.5C13 7.90446 13 8.60669 13.3371 9.11114C13.483 9.32952 13.6705 9.51702 13.8889 9.66294C14.3933 10 15.0955 10 16.5 10C17.9045 10 18.6067 10 19.1111 9.66294C19.3295 9.51702 19.517 9.32952 19.6629 9.11114C20 8.60669 20 7.89611 20 6.47495C20 5.8414 20 5.52462 19.9098 5.23452C19.8736 5.11833 19.827 5.00567 19.7704 4.89796C19.629 4.62904 19.4075 4.40751 18.9645 3.96447Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M10 6H4M4 6V2M4 6V12C4 14.8284 4 16.2426 4.87868 17.1213C5.75736 18 7.17157 18 10 18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        $menu
            ->add(
                '<span>' .
                    trans('messages.classifieds') .
                    '</span><span class="custom-tooltip"><span class="tooltip-text">' .
                    __('messages.classifieds') .
                    '</span></span>',
                ['class' => ''],
            )
            ->prepend(
...
<path d="M13.5 6.5C13.5 4.29086 15.2909 2.5 17.5 2.5C19.7091 2.5 21.5 4.29086 21.5 6.5C21.5 8.70914 19.7091 10.5 17.5 10.5H14.6429C14.5102 10.5 14.4438 10.5 14.388 10.4937C13.9244 10.4415 13.5585 10.0756 13.5063 9.61196C13.5 9.55616 13.5 9.48982 13.5 9.35714V6.5Z" stroke="currentColor" stroke-width="1.5"/>
            ...
            ->nickname('classified_posts')
            ->data('permission', 'post list')
            ->link->attr(['class' => ''])
            ->href('#classified_posts');

        $menu->classified_posts
            ->add('<span>' . trans('messages.all_form_title', ['form' => trans('messages.posts')]) . '</span>', [
                'class' => 'sidebar-layout',
                'route' => 'post.index',
            ])
            ->prepend(
...
<path d="M13 16L18 16" stroke="#currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        // Classified module-specific plan menu removed.
...
<ellipse cx="12" cy="17" rx="7" ry="4" stroke="currentColor" stroke-width="1.5"/>
            ...
            // $menu->provider
            //     ->add('<span>' .
            //             __('messages.list_form_title', ['form' => __('messages.shops')]) .
            //             '</span>',[
            //                 'class' => 'sidebar-layout',
            //                 'route' => 'shop.index',
            //     ])
...
<path d="M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        $menu
            ->add(
                '<span>' .
                    __('messages.referral_and_loyalty') .
                    '</span><span class="custom-tooltip"><span class="tooltip-text">' .
                    __('messages.referral_and_loyalty') .
                    '</span></span>',
                ['class' => ''],
            ...
            ->prepend(
                '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.04134 0C2.99112 0 2.13672 0.854402 2.13672 1.90466C2.13672 2.95492 2.99112 3.80932 4.04138 3.80932C5.09164 3.80932 5.94604 2.95492 5.94604 1.90466C5.94604 0.854402 5.0916 0 4.04134 0ZM4.04134 2.5535C3.68356 2.5535 3.3925 2.26245 3.3925 1.90466C3.3925 1.54687 3.68356 1.25582 4.04134 1.25582C4.39913 1.25582 4.69019 1.54687 4.69019 1.90466C4.69019 2.26245 4.39913 2.5535 4.04134 2.5535Z" fill="#6C757D"/>
                <path d="M5.3 3.85156H2.73339C1.91755 3.85156 1.25391 4.51521 1.25391 5.33104V7.45156C1.25391 7.79834 1.53505 8.07945 1.8818 8.07945H6.15156C6.49834 8.07945 6.77945 7.79831 6.77945 7.45156V5.33104C6.77948 4.51524 6.11584 3.85156 5.3 3.85156ZM5.52367 6.82367H2.50972V5.33104C2.50972 5.20771 2.61006 5.10738 2.73339 5.10738H5.3C5.42333 5.10738 5.52367 5.20771 5.52367 5.33104V6.82367Z" fill="#6C757D"/>
                <path d="M13.9593 9.92188C12.9091 9.92188 12.0547 10.7763 12.0547 11.8265C12.0547 12.8768 12.9091 13.7312 13.9593 13.7312C15.0096 13.7312 15.864 12.8768 15.864 11.8265C15.864 10.7763 15.0096 9.92188 13.9593 9.92188ZM13.9593 12.4754C13.6016 12.4754 13.3105 12.1843 13.3105 11.8265C13.3105 11.4688 13.6016 11.1777 13.9593 11.1777C14.3171 11.1777 14.6082 11.4688 14.6082 11.8265C14.6082 12.1843 14.3171 12.4754 13.9593 12.4754Z" fill="#6C757D"/>
                <path d="M15.2648 13.7715H12.6982C11.8824 13.7715 11.2188 14.4351 11.2188 15.251V17.3715C11.2188 17.7183 11.4999 17.9994 11.8466 17.9994H16.1164C16.4632 17.9994 16.7443 17.7182 16.7443 17.3715V15.251C16.7443 14.4351 16.0807 13.7715 15.2648 13.7715ZM12.4746 16.7436V15.2509C12.4746 15.1276 12.5749 15.0273 12.6982 15.0273H15.2648C15.3882 15.0273 15.4885 15.1276 15.4885 15.2509V16.7436H12.4746Z" fill="#6C757D"/>
                <path d="M14.4887 7.9294C13.9802 5.30963 11.6715 3.4082 8.99898 3.4082C8.6522 3.4082 8.37109 3.68935 8.37109 4.03609C8.37109 4.38288 8.65224 4.66398 8.99898 4.66398C11.0714 4.66398 12.8617 6.13787 13.2559 8.16868C13.3221 8.50952 13.652 8.73149 13.992 8.66543C14.3324 8.59934 14.5548 8.26982 14.4887 7.9294Z" fill="#6C757D"/>
                <path d="M9.00137 13.3373C6.92891 13.3373 5.13861 11.8634 4.7444 9.83261C4.67831 9.49216 4.34862 9.26973 4.00837 9.33586C3.66796 9.40195 3.44556 9.73147 3.51162 10.0719C4.02015 12.6917 6.3289 14.5931 9.00137 14.5931C9.34815 14.5931 9.62926 14.3119 9.62926 13.9652C9.62929 13.6184 9.34815 13.3373 9.00137 13.3373Z" fill="#6C757D"/>
                </svg>',
            )
            ->nickname('referral_and_loyalty')
            ->data('permission', 'loyalty list')
            ->link->attr(['class' => ''])
            ->href('#referral_and_loyalty');

        $menu->referral_and_loyalty
            ->add('<span>' . __('messages.list_form_title', ['form' => __('messages.loyalty_points')]) . '</span>', [
                'class' => 'referral-point-layout',
                'route' => 'loyalty.index',
            ])
            ->data('permission', [
                    'loyalty list',
            ...
            ->prepend(
                '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_10352_64935)">
                        <path d="M14.5543 5.26209L11.5826 4.83026L10.2535 2.13743C9.74023 1.09727 8.2559 1.09758 7.74276 2.1374L6.41374 4.83023L3.44202 5.26209C2.29407 5.42887 1.83584 6.84057 2.66616 7.65L4.81653 9.74609L4.30891 12.7057C4.11284 13.849 5.31374 14.7211 6.3402 14.1816L8.99819 12.7841L11.6562 14.1816C12.6812 14.7204 13.8835 13.8489 13.6875 12.7057L13.1799 9.74605L15.3303 7.64997C16.1607 6.84025 15.7017 5.42883 14.5543 5.26209ZM14.4925 6.79072L12.1163 9.10695C11.9749 9.2448 11.9104 9.44339 11.9438 9.63802L12.5047 12.9086C12.5329 13.0729 12.362 13.1969 12.2145 13.1195L9.27733 11.5753C9.10256 11.4834 8.8937 11.4834 8.71894 11.5753L5.78174 13.1195C5.63423 13.197 5.4634 13.0729 5.49156 12.9086L6.05251 9.63802C6.08588 9.44339 6.02137 9.2448 5.87997 9.10695L3.50372 6.79072C3.38437 6.67438 3.44965 6.47357 3.61457 6.44956L6.89844 5.97238C7.09384 5.94398 7.2628 5.82128 7.3502 5.6442L8.81882 2.66847C8.89254 2.51913 9.10373 2.51902 9.17748 2.6685L10.6461 5.6442C10.7335 5.82128 10.9025 5.94401 11.0979 5.97238L14.3817 6.44956C14.5466 6.47357 14.6119 6.67442 14.4925 6.79072Z" fill="#6C757D"/>
                        <path d="M4.73658 1.65686L4.01901 0.669219C3.82417 0.401188 3.44899 0.341703 3.18096 0.536539C2.91289 0.731305 2.85344 1.10653 3.04824 1.37459L3.76581 2.3622C3.96072 2.63037 4.33591 2.68961 4.60387 2.49488C4.87194 2.30015 4.93139 1.92493 4.73658 1.65686Z" fill="#6C757D"/>
                        <path d="M2.35539 10.5085C2.25305 10.1934 1.91456 10.0208 1.59935 10.1233L0.414726 10.5082C0.0995859 10.6107 -0.0728555 10.9491 0.0295195 11.2643C0.13207 11.5799 0.471117 11.7518 0.785555 11.6495L1.97018 11.2646C2.28536 11.1622 2.4578 10.8237 2.35539 10.5085Z" fill="#6C757D"/>
                        <path d="M14.8187 0.536519C14.5507 0.341753 14.1755 0.401132 13.9807 0.669198L13.2631 1.65681C13.0683 1.92487 13.1277 2.30013 13.3958 2.49486C13.664 2.6897 14.0392 2.63014 14.2339 2.36218L14.9514 1.37457C15.1462 1.10651 15.0868 0.731249 14.8187 0.536519Z" fill="#6C757D"/>
                        <path d="M17.5835 10.5083L16.3989 10.1233C16.0837 10.0208 15.7452 10.1934 15.6428 10.5086C15.5404 10.8237 15.7128 11.1622 16.028 11.2646L17.2126 11.6495C17.5271 11.7518 17.8661 11.5799 17.9687 11.2643C18.0711 10.9492 17.8986 10.6107 17.5835 10.5083Z" fill="#6C757D"/>
                        <path d="M8.99841 15.1602C8.66707 15.1602 8.39844 15.4288 8.39844 15.7601V16.9779C8.39844 17.3092 8.66707 17.5779 8.99841 17.5779C9.32976 17.5779 9.59839 17.3092 9.59839 16.9779V15.7601C9.59843 15.4288 9.3298 15.1602 8.99841 15.1602Z" fill="#6C757D"/>
                    </g><defs><clipPath id="clip0_10352_64935"><rect width="18" height="18" fill="white"/></clipPath></defs>
                </svg>',
            )
            ->link->attr(['class' => '']);

        $menu->referral_and_loyalty
            ->add('<span>' . __('messages.list_form_title', ['form' => __('messages.loyalty_point_history')]) . '</span>', [
                'class' => 'loyalty-point-history-layout',
                'route' => 'loyalty_history.view',
            ])
            ->data('permission', [
                    'loyalty list',
                    'loyalty add',
            ...
            ->prepend(
                '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_10352_64959)">
                        <path d="M7.9275 8.6525L10.9275 10.9025C11.1485 11.0682 11.4617 11.0235 11.6275 10.8025C11.7932 10.5815 11.7485 10.2682 11.5275 10.1025L8.75 8V3.75C8.75 3.47375 8.52625 3.25 8.25 3.25C7.97375 3.25 7.75 3.47375 7.75 3.75V8.25C7.75 8.416 7.8195 8.5655 7.9275 8.6525Z" fill="#5F60B9"/>
                        <path d="M8.50074 0.5C4.84099 0.5 1.71574 3.1415 1.10574 6.75L0.915737 6.4675C0.760987 6.23825 0.449987 6.17775 0.220737 6.3325C-0.00851262 6.48725 -0.0690126 6.79825 0.0857374 7.0275L1.08574 8.5275C1.16799 8.6525 1.30199 8.73425 1.45074 8.75H1.50074C1.63324 8.7495 1.75999 8.6965 1.85324 8.6025L3.10324 7.3525C3.29849 7.15725 3.29849 6.84025 3.10324 6.645C2.90799 6.44975 2.59099 6.44975 2.39574 6.645L2.08574 6.9575C2.66149 3.414 6.00074 1.0085 9.54399 1.58425C13.0872 2.16 15.4932 5.499 14.9175 9.0425C14.4062 12.189 11.6885 14.5005 8.50074 14.5C6.49024 14.5365 4.58874 13.588 3.40824 11.96C3.24799 11.735 2.93574 11.6823 2.71074 11.8425C2.48574 12.0027 2.43299 12.315 2.59324 12.54C3.96024 14.433 6.16624 15.5382 8.50074 15.5C12.643 15.5 16.0007 12.1423 16.0007 8C16.0007 3.85775 12.643 0.5 8.50074 0.5Z" fill="#5F60B9"/>
                    </g><defs><clipPath id="clip0_10352_64959"><rect width="16" height="16" fill="white"/></clipPath></defs>
                </svg>'
            )
            ->link->attr(['class' => '']);
...
',
        ...
        $menu->add('<span>'.__('User Plan').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('User Plan').'</span></span>', ['route' => 'user_plans.index'])
