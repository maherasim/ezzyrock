...
<nav id="navbar_main" class="mobile-offcanvas nav navbar navbar-expand-xl hover-nav horizontal-nav py-xl-0">
    <div class="container-fluid p-lg-0">
        ...
        <ul class="navbar-nav iq-nav-menu list-unstyled" id="header-menu">
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('product.*') ? 'active' : '' }}" href="{{ route('product.list') }}">{{ __('messages.products') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('post.list') || request()->routeIs('post.detail') ? 'active' : '' }}" href="{{ route('post.list') }}">{{ __('messages.classifieds') }}</a>
            </li>
