                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ html()->label(__('messages.select_name', ['select' => __('messages.category_module')]) . ' <span class="text-danger">*</span>', 'module_type')->class('form-control-label') }}
                                {{ html()->select('module_type', [
                                    'service' => __('messages.service'),
                                    'ecommerce' => __('messages.ecommerce')
                                ], $taxdata->module_type ?? 'service')
                                    ->class('form-select select2js')
                                    ->id('module_type')
                                    ->required()
                                }}
