    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('plans.index', ['module' => $module ?? ($plan->module ?? 'service')]) }}" class=" float-end btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ html()->form('POST', route('plans.store', ['module' => $module ?? ($plan->module ?? 'service')]))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->id('plan')->open() }}
                        {{ html()->hidden('id', $plan->id ?? '') }}
                        {{ html()->hidden('module', $module ?? ($plan->module ?? 'service')) }}
