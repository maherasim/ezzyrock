...
@endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="file" name="package_attachment[]" class="custom-file-input"  data-file-error="{{ __('messages.files_not_allowed') }}" multiple accept="image/jpeg,image/jpg,image/png,image/gif" >
