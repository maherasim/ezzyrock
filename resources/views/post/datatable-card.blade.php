<div class="service-box-card bg-light rounded-3 mb-5" data-post-id="{{ $data->id }}">
   <div class="iq-image position-relative">
      ...
      @endif
      <a href="{{ route('post.detail', $data->id) }}" class="service-img">
         <img src="{{ getSingleMedia($data, 'post_attachment', null) }}" alt="post"
   ...
   <a href="{{ route('post.detail', $data->id) }}" class="service-heading mt-4 d-block p-0">
