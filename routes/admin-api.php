...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('service-status', [API\ServiceController::class, 'servicestatus']);

    // Ecommerce - Products
    Route::get('get-product-list', [API\ProductController::class, 'getProductList']);
    Route::post('product-delete/{id}', [App\Http\Controllers\ProductController::class, 'destroy']);
    Route::post('product-action', [App\Http\Controllers\ProductController::class, 'action']);
    Route::post('get-product-detail', [API\ProductController::class, 'getProductDetail']);
    Route::post('product-status', [API\ProductController::class, 'productstatus']);

    // Classified - Posts
    Route::get('get-post-list', [API\PostController::class, 'getPostList']);
    Route::post('post-delete/{id}', [App\Http\Controllers\PostController::class, 'destroy']);
    Route::post('post-action', [App\Http\Controllers\PostController::class, 'action']);
    Route::post('get-post-detail', [API\PostController::class, 'getPostDetail']);
    Route::post('post-status', [API\PostController::class, 'poststatus']);
    ...
    Route::post('save-userdashboard-setting', [ SettingController::class , 'saveUserDashboardTypeSetting']);
    ...
    Route::post('PromotionalBanner-update-status',[API\PromotionalBannerController::class,'updateStatus']);
