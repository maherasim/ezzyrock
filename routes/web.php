...
use App\Http\Controllers\LoyaltyEarnRuleController;
use App\Http\Controllers\LoyaltyRedeemRuleController;
use App\Http\Controllers\LoyaltyReferralRuleController;
use App\Http\Controllers\LoyaltyRedeemPartialRuleController;
use App\Http\Controllers\LoyaltyPointActivityController;
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['middleware' => ['permission:service list']], function () {
        ...
        Route::get('/shops-by-provider', [ServiceController::class, 'getShops'])->name('service.shops-list');
    });
    ...
    // Ecommerce - Products (after Services section)
    Route::group(['middleware' => ['permission:product list']], function () {
        ...
        Route::post('product-attributes', [ProductAttributeController::class, 'storeAttribute'])->name('product-attributes.store');
        Route::put('product-attributes/{productAttribute}', [ProductAttributeController::class, 'updateAttribute'])->name('product-attributes.update');
        Route::delete('product-attributes/{productAttribute}', [ProductAttributeController::class, 'deleteAttribute'])->name('product-attributes.destroy');
        Route::post('product-attributes/options', [ProductAttributeController::class, 'storeOption'])->name('product-attributes.options.store');
        Route::put('product-attributes/options/{productAttributeOption}', [ProductAttributeController::class, 'updateOption'])->name('product-attributes.options.update');
        Route::delete('product-attributes/options/{productAttributeOption}', [ProductAttributeController::class, 'deleteOption'])->name('product-attributes.options.destroy');
        Route::get('product-units', [ProductUnitController::class, 'index'])->name('product-units.index');
        Route::post('product-units', [ProductUnitController::class, 'store'])->name('product-units.store');
        ...
        Route::get('product-index-data', [ProductController::class, 'index_data'])->name('product.product-index-data');
        ...
        Route::get('/product-shops-by-provider', [ProductController::class, 'getShops'])->name('product.shops-list');
        ...
        Route::get('product-review-index-data', [ProductReviewController::class, 'index_data'])->name('product-review.index_data');
        Route::delete('product-review/{id}', [ProductReviewController::class, 'destroy'])->name('product-review.destroy');

        Route::get('product-orders', [AdminProductOrderController::class, 'index'])->name('admin.product-orders.index');
        Route::get('product-orders/{productOrder}', [AdminProductOrderController::class, 'show'])->name('admin.product-orders.show');
        Route::put('product-orders/{productOrder}', [AdminProductOrderController::class, 'update'])->name('admin.product-orders.update');
    });

    // Classified - Posts (after Services section)
    Route::group(['middleware' => ['permission:post list']], function () {
        Route::resource('post', PostController::class);
        Route::get('post-index-data', [PostController::class, 'index_data'])->name('post.post-index-data');
        Route::post('post-bulk-action', [PostController::class, 'bulk_action'])->name('post.bulk-action');
        Route::post('post-action', [PostController::class, 'action'])->name('post.action');
        Route::post('post/{id}', [PostController::class, 'destroy'])->name('post.destroy');
        Route::get('/post-shops-by-provider', [PostController::class, 'getShops'])->name('post.shops-list');
    ...
    Route::get('provider-shop/{id}', [ProviderController::class, 'getProviderShop'])->name('provider.shop-list');
    ...
    Route::get('handymanreview/{id}', [HandymanController::class, 'review'])->name('handyman.review');
    ...
    Route::get('cash-order-index-data', [PaymentController::class, 'cash_order_index_data'])->name('cash.order_index_data');
    Route::get('payment-index-data', [PaymentController::class, 'index_data'])->name('payment.index_data');
    Route::get('payment-subscription-index-data', [PaymentController::class, 'subscription_index_data'])->name('payment.subscription_index_data');
    ...
    Route::get('comission_handyman/{id}', [SettingController::class, 'comission_handyman'])->name('setting.comission_handyman');
    // Route::post('provider/{id}', [HandymanController::class, 'destroy_handyman'])->name('handyman.destroy');
    ...
    Route::get('/dashboard/revenue/filter', [SettingController::class, 'filterRevenue'])->name('dashboard.revenue.filter');
    ...
    Route::group(['middleware' => ['permission:document list|providerdocument list']], function () {
        ...
        Route::post('check-unique', [DocumentsController::class, 'checkUnique'])->name('documents.checkUnique');
    });
    ...
    Route::group(['middleware' => ['permission:shopdocument list']], function () {
        Route::resource('shopdocument', ShopDocumentController::class);
        Route::get('shopdocument-index-data', [ShopDocumentController::class, 'index_data'])->name('shopdocument.index_data');
        Route::post('shopdocument-bulk-action', [ShopDocumentController::class, 'bulk_action'])->name('shopdocument.bulk-action');
        Route::post('shopdocument-action', [ShopDocumentController::class, 'action'])->name('shopdocument.action');
        Route::post('shopdocument/{id}', [ShopDocumentController::class, 'destroy'])->name('shopdocument.destroy');
        Route::get('shopdocument-list', [ShopDocumentController::class, 'loadDocuments'])->name('shopdocument.documentlist');
    });
    ...
    // Route::get('providerSubscriptionDetail/{id}', [SubscriptionController::class, 'providerSubscriptionDetail'])->name('providerSubscriptionDetail');
    ...
    Route::group(['prefix' => 'shop', 'as' => 'shop.', 'middleware' => ['permission:shop list']], function () {
        Route::get('/', [ShopController::class, 'index'])->name('index'); // list all shops
        Route::get('/index_data', [ShopController::class, 'index_data'])->name('index_data'); // get all shops data for datatable
        Route::post('bulk-action', [ShopController::class, 'bulk_action'])->name('bulk_action');
        Route::post('/shop/check-registration', [ShopController::class, 'checkRegistration'])->name('checkRegistration');

        Route::group(['middleware' => ['permission:shop add']], function () {
            Route::get('/create', [ShopController::class, 'create'])->name('create'); // create new shop form
            Route::post('/', [ShopController::class, 'store'])->name('store'); // create new shop
        });

        Route::get('/{id}', [ShopController::class, 'show'])->name('show'); // view shop details

        Route::group(['middleware' => ['permission:shop edit']], function () {
            Route::get('/{id}/edit', [ShopController::class, 'edit'])->name('edit'); // edit shop details
            Route::post('/{id}/update', [ShopController::class, 'update'])->name('update'); // update shop details
        });

        Route::get('/get-countries', [ShopController::class, 'getCountries'])->name('get-countries');
        Route::get('/get-states/{countryId}', [ShopController::class, 'getStates'])->name('get-states');
        Route::get('/get-cities/{stateId}', [ShopController::class, 'getCities'])->name('get-cities');

        Route::group(['middleware' => ['permission:shop delete']], function () {
            Route::post('/delete/{id}', [ShopController::class, 'delete'])->name('delete'); // Soft delete
        });

        Route::post('/restore/{id}', [ShopController::class, 'restore'])->name('restore'); // Restore from trash
        Route::post('/force-delete/{id}', [ShopController::class, 'forceDelete'])->name('force_delete'); // Permanently delete
        Route::get('/get-providers/list', [ShopController::class, 'getProviders'])->name('get_providers');
        Route::get('/get-services/{provider}', [ShopController::class, 'getServices'])->name('get_services');
    });
    ...
    Route::group(['middleware' => ['permission:plan list|plan add']], function () {
        Route::get('subscriptions/extend', [AdminSubscriptionController::class, 'create'])->name('admin.subscription.extend');
        Route::post('subscriptions/extend', [AdminSubscriptionController::class, 'store'])->name('admin.subscription.extend.store');
    });
    ...
    Route::get('providerdetail/{id}', [ProviderController::class, 'providerSubscription'])->name('plan.view');


    Route::group(['middleware' => ['permission:loyalty list']], function () {

        Route::get('/referral-loyalty', [LoyaltyEarnRuleController::class, 'index'])->name('loyalty.index');

        // Earn Rule Routes
        Route::get('/index-earn-rule', [LoyaltyEarnRuleController::class, 'index_data'])->name('index.earn_rule');
        Route::post('/store-earn-rule', [LoyaltyEarnRuleController::class, 'store'])->name('store.earn_rule');
        Route::post('/delete-earn-rule/{id}', [LoyaltyEarnRuleController::class, 'delete'])->name('delete.earn_rule');
        Route::post('/restore-earn-rule/{id}', [LoyaltyEarnRuleController::class, 'restore'])->name('restore.earn_rule');
        Route::post('/force-delete-earn-rule/{id}', [LoyaltyEarnRuleController::class, 'forceDelete'])->name('force_delete.earn_rule');
        Route::get('/get-edit-earn-rule/{id}', [LoyaltyEarnRuleController::class, 'edit'])->name('edit.earn_rule');
        Route::post('/update-earn-rule/{id}', [LoyaltyEarnRuleController::class, 'update'])->name('update.earn_rule');
        Route::post('/bulk-action-earn-rule', [LoyaltyEarnRuleController::class, 'bulk_action'])->name('bulk_action.earn_rule');
        Route::get('/get-earn-service-type-data', [LoyaltyEarnRuleController::class, 'getServiceTypeData'])->name('loyalty.earn_service_type_data');


        Route::get('/index-redeem-rule', [LoyaltyRedeemRuleController::class, 'index_data'])->name('index.redeem_rule');
        Route::post('/store-redeem-rule', [LoyaltyRedeemRuleController::class, 'store'])->name('store.redeem_rule');
        Route::post('/delete-redeem-rule/{id}', [LoyaltyRedeemRuleController::class, 'delete'])->name('delete.redeem_rule');
        Route::post('/restore-redeem-rule/{id}', [LoyaltyRedeemRuleController::class, 'restore'])->name('restore.redeem_rule');
        Route::post('/force-delete-redeem-rule/{id}', [LoyaltyRedeemRuleController::class, 'forceDelete'])->name('force_delete.redeem_rule');
        Route::get('/get-edit-redeem-rule/{id}', [LoyaltyRedeemRuleController::class, 'edit'])->name('edit.redeem_rule');
        Route::post('/update-redeem-rule/{id}', [LoyaltyRedeemRuleController::class, 'update'])->name('update.redeem_rule');
        Route::post('/bulk-action-redeem-rule', [LoyaltyRedeemRuleController::class, 'bulk_action'])->name('bulk_action.redeem_rule');
        Route::get('/get-redeem-service-type-data', [LoyaltyRedeemRuleController::class, 'getServiceTypeData'])->name('loyalty.redeem_service_type_data');

        // Referral Rule Routes
        Route::get('/index-referral-rule', [LoyaltyReferralRuleController::class, 'index_data'])->name('index.referral_rule');
        Route::post('/store-referral-rule', [LoyaltyReferralRuleController::class, 'store'])->name('store.referral_rule');
        Route::post('/delete-referral-rule/{id}', [LoyaltyReferralRuleController::class, 'delete'])->name('delete.referral_rule');
        Route::post('/restore-referral-rule/{id}', [LoyaltyReferralRuleController::class, 'restore'])->name('restore.referral_rule');
        Route::post('/force-delete-referral-rule/{id}', [LoyaltyReferralRuleController::class, 'forceDelete'])->name('force_delete.referral_rule');
        Route::get('/get-edit-referral-rule/{id}', [LoyaltyReferralRuleController::class, 'edit'])->name('edit.referral_rule');
        Route::post('/update-referral-rule/{id}', [LoyaltyReferralRuleController::class, 'update'])->name('update.referral_rule');
        Route::post('/bulk-action-referral-rule', [LoyaltyReferralRuleController::class, 'bulk_action'])->name('bulk_action.referral_rule');

        // Partial Redeem Rule Routes
        Route::get('/partial-rule', [LoyaltyRedeemPartialRuleController::class, 'index'])->name('view.partial_rule');
        Route::get('/index-partial-rule', [LoyaltyRedeemPartialRuleController::class, 'index_data'])->name('index.partial_rule');
        Route::post('/store-partial-rule', [LoyaltyRedeemPartialRuleController::class, 'store'])->name('store.partial_rule');
        Route::post('/delete-partial-rule/{id}', [LoyaltyRedeemPartialRuleController::class, 'delete'])->name('delete.partial_rule');
        Route::post('/restore-partial-rule/{id}', [LoyaltyRedeemPartialRuleController::class, 'restore'])->name('restore.partial_rule');
        Route::post('/force-delete-partial-rule/{id}', [LoyaltyRedeemPartialRuleController::class, 'forceDelete'])->name('force_delete.partial_rule');
        Route::get('/get-edit-partial-rule/{id}', [LoyaltyRedeemPartialRuleController::class, 'edit'])->name('edit.partial_rule');
        Route::post('/update-partial-rule/{id}', [LoyaltyRedeemPartialRuleController::class, 'update'])->name('update.partial_rule');
        Route::post('/bulk-action-partial-rule', [LoyaltyRedeemPartialRuleController::class, 'bulk_action'])->name('bulk_action.partial_rule');

        Route::get('/loyalty-history-index', [LoyaltyPointActivityController::class, 'index'])->name('loyalty_history.view');
        Route::get('/loyalty-history-data', [LoyaltyPointActivityController::class, 'index_data'])->name('loyalty_history.index_data');
        Route::get('/points-dashboard/{id}', [LoyaltyPointActivityController::class, 'points_dashboard'])->name('points.dashboard');
    });



    // Route::get('providerdetail/{id}', [ProviderController::class, 'providersubscriptiondata'])->name('providersubscriptiondata');
