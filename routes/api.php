...
Route::post('check-referral', [API\User\UserController::class, 'validateReferralCode']);
...
Route::get('shop-list', [API\ShopController::class, 'getShopList']);
Route::get('shop-detail/{id}', [API\ShopController::class, 'getShopDetail']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('product-form-config', [API\ProductController::class, 'getProductFormConfig']);
    ...
    Route::get('shop-document-list', [API\ShopDocumentController::class, 'getShopDocumentList']);
    Route::post('shop-document-save', [App\Http\Controllers\ShopDocumentController::class, 'store']);
    Route::post('shop-document-delete/{id}', [App\Http\Controllers\ShopDocumentController::class, 'destroy']);
    Route::post('shop-document-action', [App\Http\Controllers\ShopDocumentController::class, 'action']);
    ...
    Route::post('user-subscription-razorpay-verify', [API\SubscriptionController::class, 'verifyUserSubscriptionRazorpay']);
    ...
    Route::post('cart-razorpay-verify', [API\ProductCartController::class, 'verifyRazorpay']);
...
Route::post('/phonepe/callback', [API\BookingController::class, 'callback']);
Route::match(['get', 'post'], '/product-phonepe/callback', [App\Http\Controllers\UserProductCartController::class, 'productPhonePeCallback']);
Route::match(['get', 'post'], '/subscription-phonepe/callback', [App\Http\Controllers\UserSubscriptionController::class, 'subscriptionPhonePeCallback']);
