...
class TaxController extends Controller
{
    ...
    public function index_data(DataTables $datatable,Request $request)
    {
        ...
        if (isset($filter)) {
            ...
            if (!empty($filter['column_module_type'])) {
                $query->where('module_type', $filter['column_module_type']);
            }
        }
        ...
        ->editColumn('module_type', function ($query) {
            return ucfirst((string) ($query->module_type ?? 'service'));
        })
