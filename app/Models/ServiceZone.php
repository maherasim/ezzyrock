...
class ServiceZone extends Model
{
    ...
    {
        return $this->belongsToMany(Product::class, 'product_zone_mappings', 'zone_id', 'product_id');
    }

    public function posts()
    {
        return $this->belongsToMany(Post::class, 'post_zone_mappings', 'zone_id', 'post_id');
    }
}
