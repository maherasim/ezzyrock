...
class User extends Authenticatable implements HasMedia
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($user) {
            // Only generate for provider or customer
    ...
    public function providerProductTaxMapping()
    {
        return $this->hasMany(ProviderProductTaxMapping::class, 'provider_id', 'id');
    }
    public function providerProductTaxMappingData()
    {
        return $this->hasMany(ProviderProductTaxMapping::class, 'provider_id', 'id')->with('taxes');
    }
    ...
    {
        return $this->hasMany(Shop::class, 'provider_id', 'id');
    }
